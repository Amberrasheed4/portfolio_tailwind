...
function Contact() {
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-12">
      ...
      Feel free to reach out to me for any inquiries, collaboration opportunities, or project discussions. I’m always excited to connect and explore how we can work together to create something impactful. Let’s build something amazing!.
      </p>
    </div>
      ...
      <div className="flex flex-wrap -m-2">
        ...
        <div className="p-2 w-full">
          <div className="relative">
            <label
              htmlFor="message"
              className="leading-7 text-sm text-whitei"
            >
              Message
            </label>
            <textarea
